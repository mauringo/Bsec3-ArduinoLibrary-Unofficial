 ...
 * @param[in] bsec  : Bsec3 class object
 */
 ...
 * @param[in] bsec  : Bsec3 class object
 */
void updateBsecState(Bsec3 bsec);
 ...
 * @param : Bsec3 class object
 */
bool loadState(Bsec3 bsec);

/**
 * @brief : This function writes the state into EEPROM
 * @param : Bsec3 class object
 */
bool saveState(Bsec3 bsec);

/* Create an object of the class Bsec3 */
Bsec3 envSensor;
#ifdef USE_EEPROM
...
void newDataCallback(const bme68xData data, const bsecOutputs outputs, Bsec3 bsec)
{
    if (!outputs.nOutputs)
        return;
